...
check "no existing config: plugins has exactly the 7 ruixen ids" \
  ...
  '["ruixen.cava","ruixen.frame-widget","ruixen.launcher","ruixen.media","ruixen.notch","ruixen.settings","ruixen.wallpaper"]'
...
check "customized: ruixen plugin ids present exactly once each (idempotent, not duplicated)" \
  ...
  '["ruixen.cava","ruixen.frame-widget","ruixen.launcher","ruixen.media","ruixen.notch","ruixen.settings","ruixen.wallpaper","third-party.widget"]'
...
check "already ruixen.bar: existing ruixen plugin entry's extra field survives" \
  ...
  '{"id":"ruixen.notch","someFutureField":true}'
check "already ruixen.bar: missing ruixen ids (frame-widget, wallpaper, media, launcher, cava) still get appended" \
...
check "structural gap: unrelated entries/settings/order elsewhere survive untouched (docked, center, plugins)" \
  ...
  '{"docked":true,"center":[{"id":"ruixen.weather"},{"id":"omarchy.clock","format":"HH:mm"}],"plugins":["ruixen.notch","ruixen.frame-widget","ruixen.settings","ruixen.wallpaper","ruixen.media","ruixen.launcher","ruixen.cava"]}'
